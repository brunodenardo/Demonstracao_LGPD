...
export class Backend1732658312360 implements MigrationInterface {
    name = 'Backend1732658312360'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "termos_uso" ALTER COLUMN "data_cracao" SET DEFAULT '"2024-11-26T21:58:34.005Z"'`);
