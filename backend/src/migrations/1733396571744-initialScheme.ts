...
export class InitialScheme1733396571744 implements MigrationInterface {
    name = 'InitialScheme1733396571744'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "aceites_itens" ("id" SERIAL NOT NULL, "aceito" boolean NOT NULL, "ativo" boolean NOT NULL DEFAULT true, "dataInteracao" TIMESTAMP NOT NULL DEFAULT now(), "usuarioIdUsuario" integer, "termoId" integer, "itemId" integer, CONSTRAINT "PK_8e3cb7ff517e1a73651e9a6dd8b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "usuario" ("id_usuario" SERIAL NOT NULL, "nome_completo" character varying NOT NULL, "data_nascimento" TIMESTAMP NOT NULL, "senha" character varying NOT NULL, "email" character varying NOT NULL, "cpf" character varying NOT NULL, "cep" character varying NOT NULL, "ativo" boolean NOT NULL, "tipo" character varying NOT NULL DEFAULT 'COMUM', CONSTRAINT "UQ_2863682842e688ca198eb25c124" UNIQUE ("email"), CONSTRAINT "PK_dd52716c2652e0e23c15530c695" PRIMARY KEY ("id_usuario"))`);
        ...
        await queryRunner.query(`ALTER TABLE "aceites_itens" ADD CONSTRAINT "FK_5f9afd9aa8dde546226e4db50b4" FOREIGN KEY ("usuarioIdUsuario") REFERENCES "usuario"("id_usuario") ON DELETE CASCADE ON UPDATE NO ACTION`);
